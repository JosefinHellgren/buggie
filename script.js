...
startButton.addEventListener('click',function(){
   ...
   let randomizedWords = setInterval(function(){

    let generatedWords =["majs","banan","russin","gurka","päron","kalaspuff","ris","pudding","äpple","gräs","citron"];
let randomIndex = Math.floor(Math.random() * 11);

antagonist.innerText = generatedWords[randomIndex];
        ...
        if (hero.left < enenmy.left + enenmy.width  && hero.left + hero.width  > enenmy.left &&
              hero.top < enenmy.top + enenmy.height && hero.top + hero.height > enenmy.top) {
                console.log("chaught");
                    ...
                    if(antagonist.innerText == "päron" || antagonist.innerText == "citron" || antagonist.innerText == "banan" || antagonist.innerText == "äpple"){
                ...
                console.log(antagonist.innerText)
