...
startButton.addEventListener('click',function(){
   ...
   let fruitChange = setInterval(function(){
    ...
    let randomThings =["images/poison.png","images/apple.png","images/bananas.png","images/watermelon.png","images/lemon.png","images/pear.png","images/cat.png","images/poison.png","images/sneakers.png","images/hot-dog.png","images/hamburger.png"];
    let randomFruits = Math.floor(Math.random() * 11);
    img.src = randomThings[randomFruits];
        ...
        if (hero.left < enenmy.left + enenmy.width  && hero.left + hero.width  > enenmy.left &&
              hero.top < enenmy.top + enenmy.height && hero.top + hero.height > enenmy.top) {
                ...
                const realSrc = img.getAttribute('src');
                    ...
                    if(realSrc == "images/pear.png" || realSrc == "images/apple.png" || realSrc == "images/bananas.png" || realSrc == "images/lemon.png" || realSrc == "images/watermelon.png"){
                        score.innerText = newScore++;
                        //the element disapears
                    } else if(realSrc == "images/poison.png"){
                        score.innerText = newScore--;
